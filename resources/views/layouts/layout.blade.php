    ...
    <div class="navbar-nav d-flex justify-content-end">
            ...
            <li class="nav-item dropdown">
                  ...
                  @foreach(auth()->user()->unreadNotifications as $notification)
                       <li><a class="dropdown-item" href="/article/show/{{ $notification->data['article']['id']}}?notify={{$notification->id}}">{{ $notification->data['article']['name']}}</a></li>
                  @endforeach
                  </ul>
              </li>
              <li class="nav-item">
...
<footer class="bg-light text-center text-lg-start mt-5" style="position:absolute; bottom: 0; width: 100%;">
  <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
    Соколов Владислав Сергеевич, 211-322
  </div>
</footer>
